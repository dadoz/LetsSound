package com.application.letssound.loader;

/**
 * Created by davide-syn on 10/30/17.
 */
...
public class SongLoader {
    protected static final String BASE_SELECTION = IS_MUSIC + "=1" + " AND " + AudioColumns.TITLE + " != ''";
